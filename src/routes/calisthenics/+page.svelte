...
<main class="p-8 h-full flex flex-col justify-center items-center">
    <div class="flex flex-col justify-center items-center">
        ...
        <h2 class="mt-6 w-3/4 text-xl text-center">
            There's a lot of information out there about Calisthenics, and it'd be nice to have all of it
            in just one place. If you'd like to get involved and help improve this reference,
            <a href="/" class="text-blue-500">click here</a>. Otherwise, feel free to explore.
        </h2>
