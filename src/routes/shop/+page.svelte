...
<main class="py-20 gap-16 flex flex-col justify-center items-center">
    ...
    <div class="w-full px-20 gap-12 grid grid-cols-3 justify-center items-center">
        <div class="w-full aspect-square flex justify-center items-center bg-neutral-50 rounded-3xl transition-colors duration-300 overflow-hidden group relative">
